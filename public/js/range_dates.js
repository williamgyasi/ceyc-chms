...
$.fn.dataTableExt.afnFiltering.push(
	function (oSettings, aData, iDataIndex) {
		...
		var datofini = aData[iStartDateCol].substring(8, 10) + aData[iStartDateCol].substring(2, 10) + aData[iStartDateCol].substring(0, 1);
		var datoffin = aData[iEndDateCol].substring(8, 10) + aData[iEndDateCol].substring(2, 5) + aData[iEndDateCol].substring(0, 1);
